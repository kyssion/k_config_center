...
/// <summary>创建命名空间请求：校验长度与表结构对齐（namespace_key/name VARCHAR(128)、description VARCHAR(512)）</summary>
...
public record NamespaceCreateRequest(
    [Required, StringLength(128)] string NamespaceKey,
    [Required, StringLength(128)] string NamespaceName,
...
public record NamespaceUpdateRequest(
    [Required, StringLength(128)] string NamespaceName,
    [StringLength(512)] string? Description,
